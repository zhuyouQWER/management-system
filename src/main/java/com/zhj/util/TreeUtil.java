...
public class TreeUtil {
     ...
     * @return
     */
    public final static List<Jurisdiction> getFatherNode(List<Jurisdiction> treesList){
        List<Jurisdiction> newTrees = new ArrayList<Jurisdiction>();
        for (Jurisdiction mt : treesList) {
     ...
     * @return
     */
    private final static List<Jurisdiction> getChildrenNode(String pId, List<Jurisdiction> treesList){
        List<Jurisdiction> newTrees = new ArrayList<Jurisdiction>();
        for (Jurisdiction mt : treesList) {
